function [dtt_size11 Bitration]=dtt_JPEGEncode(I)

% I=imread('I:\经典图片\image compress databse\kodim03.png');
...
I=dtt_transform(I,row,column,8);
%JPEG建议量化矩阵
I=round(I);%%向靠近的整数取圆整
...
dtt_size11=numel(FileCode)-32
dtt_bit_ration=8*row*column/dtt_size11
Bitration=dtt_size11/(row*column);
% fid=fopen('c','wb');
% fwrite(fid,FileCode);
% fclose(fid);
%合并文件头与文件体
